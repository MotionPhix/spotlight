...
<div class="space-y-8">
        ...
        <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/30 dark:border-gray-700/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div class="text-2xl font-bold text-orange-600 dark:text-orange-400">{{ $stats['pending_registrations'] }}</div>
        ...
        <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/30 dark:border-gray-700/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $stats['completed_registrations'] }}</div>
        ...
        <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/30 dark:border-gray-700/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $stats['payment_pending'] }}</div>
        ...
        <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-200/30 dark:border-gray-700/30 hover:shadow-2xl hover:scale-105 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">MWK {{ number_format($stats['total_revenue'], 2) }}</div>
    ...
    <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200/30 dark:border-gray-700/30">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="{{ route('admin.communications.index') }}" class="group">
            ...
            <a href="{{ route('admin.notifications.index') }}" class="group">
    ...
    <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200/30 dark:border-gray-700/30">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.users.index') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">View all →</a>
        </div>
        <div class="space-y-3">
